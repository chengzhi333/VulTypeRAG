...
class TextCNN(nn.Module):
    ...
    def forward(self, 
        ...
        emb_x = self.gpt.wte(input_ids)
        attention_mask = input_ids.ne(self.tokenizer.pad_token_id).unsqueeze(-1).expand(input_ids.shape[0], input_ids.shape[1], emb_x.shape[-1])
